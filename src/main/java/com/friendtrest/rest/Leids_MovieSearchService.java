...
public class Leids_MovieSearchService {
    ...
    public Leids_MovieSearchService(){
        ...
        tags.add("Sci-Fi");
        tags.add("Action");
        movies.add(new Movie("The Matrix", 1999, "R", cast, tags));
        ...
        tags.add("Adventure");
        tags.add("Sci-Fi");
        movies.add(new Movie("Iron Man", 2008, "PG-13", cast, tags));
        ...
        tags.add("Action");
        tags.add("Sci-Fi");
        movies.add(new Movie("The Avengers", 2012, "PG-13", cast, tags));
        ...
        tags.add("Adventure");
        tags.add("Comedy");
        movies.add(new Movie("Deadpool", 2016, "R", cast, tags));
